...
urlpatterns = [
    ...
    url(r'^Forum/Topic_edit_result/$',                  views.Topic_edit_result,    name='Forum_Topic_edit_result_page'),#论坛主题编辑页面
    url(r'^Forum/Comment_edit/(?P<Topic_id>[0-9]+)/$',   views.Comment_edit,         name='Forum_Comment_edit_page'  ),#论坛评论编辑页面
    url(r'^Forum/Comment_edit_result/(?P<editing_topic_id>[0-9]+)/$',   views.Comment_edit_result,  name='Forum_Comment_edit_result_page'),#论坛评论编辑页面
